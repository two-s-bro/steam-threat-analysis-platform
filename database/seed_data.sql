...
-- SteamID
('steamid', '[REDACTED_STEAMID64]', 'MEDIUM', 'SteamPatchToast_patch.lo', '受害者 SteamID64，已回传至 C2', 2),
...
('2026-06-15 23:29:29', 'HEARTBEAT', 'C2 心跳上报 (第2次)', '[REDACTED_STEAMID64]----匹配成功----已经下载过----进程已经存在', 2),
('2026-06-15 23:33:04', 'HEARTBEAT', 'C2 心跳上报 (第3次)', '[REDACTED_STEAMID64]----匹配成功----已经下载过----进程已经存在', 2),
...
('2026-06-16 22:53:44', 'HEARTBEAT', '最后一次 C2 心跳', '[REDACTED_STEAMID64]----匹配成功----已经下载过----进程已经存在 (日志终止)', 2);
